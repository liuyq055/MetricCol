...
class ResBottleneckBlock(nn.Module):
    ...
    It contains 3 conv Metric_Layers with kernels 1x1, 3x3, 1x1.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            bottleneck_channels (int): number of output channels for the 3x3
                "bottleneck" conv Metric_Layers.
            norm (str or callable): normalization for all conv Metric_Layers.
                See :func:`Metric_Layers.get_norm` for supported format.
            act_layer (callable): activation for all conv Metric_Layers.
        """
        super().__init__()
